...
const repeated = {
  key: 'pt:exquisito:cross-language-transfer:es',
  occurrences: 2
};
...
assert.deepStrictEqual(result.repeated, [repeated]);
assert.notStrictEqual(result.repeated[0], repeated);
assert.strictEqual(Object.isFrozen(result.repeated[0]), true);
